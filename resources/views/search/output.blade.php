            ...
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{url('/search')}}" method="GET" class="space-y-2 mb-6">
                        ...
                        {{$results->links()}}
                        @endif
                        <div class="mt-5 grid grid-cols-1 md:grid-cols-1 gap-6 lg:gap-8">
                                @forelse($results as $result)
                                    <a href="{{route('posts.show',$result)}}" class="group relative block bg-black rounded-lg">
                                        <img
                                            alt="Developer"
                                            src="{{url('storage/uploads/thumbnails/'.$result->image_filename)}}"
                                        ...
                                        <div class="relative p-4 sm:p-6 lg:p-8">
                                            ...
                                            <p class="text-xl font-bold text-white sm:text-2xl">{{$result->title}}</p>
                                            ...
                                            <div class="mt-32 sm:mt-48 lg:mt-64">
                                                ...
                                                >
                                                    ...
                                                    <p class="text-pink-500 block mt-4 text-sm">Views: {{$result->visit_count_total}}</p>
                                                    <p class="text-pink-500 block  text-sm">Updated: {{$result->updated_at->diffForHumans()}}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
