<x-app-layout>
    ...
    <div class="py-12 dark:bg-slate-900">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 dark:bg-slate-900">
            @if (session('success'))
            ...
            @endif
                ...
                <div class="grid md:grid-cols-3 sm:grid-cols-1 gap-4">
                    @forelse($posts as $post)
                        <a href="{{route('trashed.show',$post)}}">
                            <div class=" md:hover:scale-105 scale-100 transform-gpu dark:bg-gray-800 my-6 p-6 bg-white border-b border-gray-200 dark:border-gray-800 shadow-sm rounded-md sm:rounded-lg">
