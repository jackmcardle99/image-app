...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-gradient-to-tr from-indigo-900 to-pink-900">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen  selection:bg-red-500 selection:text-white">
            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                @auth
                    <a href="{{ url('/posts') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Posts</a>
                @else
    ...
    @endif
            ...
            <div class="max-w-7xl mx-auto p-6 lg:px-8">
                ...
                <div class="mt-16 ">
                    <div class="grid md:grid-flow-col sm:auto-cols-1 gap-6 lg:gap-8">
